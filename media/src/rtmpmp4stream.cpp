...
RTMPMP4Stream::RTMPMP4Stream(DWORD id) : RTMPStream(id), streamer(this)
{
	encoder = NULL;
	decoder = NULL;
	desc = NULL;
...
bool RTMPMP4Stream::Publish(std::wstring& url)
{
	return false;
}

void RTMPMP4Stream::PublishCommand(const wchar_t *name,AMFData* obj)
{
	return;
}

bool RTMPMP4Stream::Seek(DWORD time)
{
	//Get
